...
func tutorial(bt):
	...
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_007.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
	...
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_008.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
	...
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_009.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
	...
	bt.unhighlight()
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_005.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
	...
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_011.png", {"scale": 0.8, "side": "center", "position": [0, -348]})
	...
	if result == "win":
		matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_013.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
		...
		matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_012.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
		matilda.band("...あんた、パーを出せって言っただろ。")
		matilda.band("まぁいい、次で取り返しな。", {"append": true})
	else:
		matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_006.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
		matilda.band("あいこか。同じグレードだと引き分けになる。")

	# HPの説明
	bt.highlight("opponent_hp", {"offset_y": 20})
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_010.png", {"scale": 0.8, "side": "center", "position": [0, -199]})
...
func outfit_3(bt):
	...
	if result == "win":
		...
		bt.bubble("くっ・・・、しょうがないな・・・・", {"side": "right"})
		...
		bt.bubble("・・・・・あんまり、まじまじ見るなよぉ・・・・・", {"side": "right"})
		...
		matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_015.png", {"scale": 0.80, "side": "center", "position": [0, -194]})
		matilda.band("やっぱり、真剣勝負も弱いわね。ふっ。")

	else:
		matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_012.png", {"scale": 0.80, "side": "center", "position": [0, -236]})
...
func outfit_2(bt):
	...
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_016.png", {"scale": 0.80, "side": "center", "position": [0, -187]})
	...
	if result == "win":
		...
		matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_019.png", {"scale": 0.54, "side": "center", "position": [0, -132]})
...
func outfit_1(bt):
	...
	matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_020.png", {"scale": 0.67, "side": "center", "position": [13, -243],})
	...
	if result == "win":
		...
		bt.bubble("さ、さぁ。脱いだぞ・・・\nこれでいいよな？", {"side": "right"})
		bt.bubble("いいわけないの、わかってますよね？", {"side": "left"})
		bt.bubble("・・・・・・・・", {"side": "right"})
		...
		matilda.set_portrait("res://assets/characters/mob/guard/default/guard_default_023.png", {"scale": 0.67, "side": "center", "position": [0, -204]})
