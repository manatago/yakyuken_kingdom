...
func get_opponent_hand() -> Array:
	return [
		{"hand": "rock", "grade": 2}, {"hand": "rock", "grade": 3}, {"hand": "rock", "grade": 3},
		{"hand": "scissors", "grade": 2}, {"hand": "scissors", "grade": 3}, {"hand": "scissors", "grade": 3},
...
func outfit_3(bt):
	...
	seles.set_portrait(SELES_PORTRAIT, {"scale": 0.5, "side": "center", "position": [0, -260], "appear_effect": "fade_slide", "appear_from": "right", "appear_duration": 0.4})
	if _is_first_battle():
		seles.band("縛鎖、発動。")
	else:
