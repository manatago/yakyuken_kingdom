...
func get_opponent_hand() -> Array:
	return [
		{"hand": "rock", "grade": 3}, {"hand": "rock", "grade": 3}, {"hand": "rock", "grade": 3},
		{"hand": "scissors", "grade": 3}, {"hand": "scissors", "grade": 3}, {"hand": "scissors", "grade": 3},
...
func outfit_3(bt):
	...
	princess.set_portrait(PRINCESS_PORTRAIT, {"scale": 0.5, "side": "center", "position": [0, -260], "appear_effect": "fade_slide", "appear_from": "right", "appear_duration": 0.4})
	if _is_first_battle():
