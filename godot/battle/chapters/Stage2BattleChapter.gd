...
func outfit_3(bt):
	...
	if result == "win":
		...
		rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_004.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
		rec.band("あら、引き分け？")
...
func outfit_2(bt):
	var rec = bt.character("receptionist")
	rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_005.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
	rec.band("……ちょっと、見ないでよ。")
	...
	if result == "win":
		rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_006.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
		rec.band("……っ、また負けた……。")
	elif result == "lose":
		rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_007.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
		rec.band("ほら、油断するからよ。")
	else:
		rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_008.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
...
func outfit_1(bt):
	var rec = bt.character("receptionist")
	rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_009.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
	...
	if result == "win":
		rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_010.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
		rec.band("いやぁぁぁ！！")
	elif result == "lose":
		rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_011.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
		rec.band("ふぅ……助かった……。")
	else:
		rec.set_portrait("res://assets/characters/stage2_battle/char10_st2_battle_012.png", {"scale": 0.32, "side": "center", "position": [0, -275]})
		rec.band("……まだ終わらないの？")
