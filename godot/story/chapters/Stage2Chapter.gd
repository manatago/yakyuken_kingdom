...
const HERO_AWKWARD := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_067.png" # バツの悪い顔
const HERO_ENCHANTED := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_015.png" # 見惚れて呆然
const HERO_HAPPY := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_072.png"  # 幸福顔
const HERO_EXALT := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_014.png"  # 陶酔
const HERO_DOWN := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_033.png"   # 机に突っ伏す
const HERO_FORWARD := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_089.png" # 身を乗り出す
const HERO_RESIGN := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_011.png"  # 観念して伏し目
const HERO_DAZED := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_028.png"   # 呆然
const HERO_DREAD := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_064.png"   # 嫌な予感
const HERO_SERIOUS := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_011.png" # 真剣
...
const HERO_DESPAIR := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_070.png" # 愕然
const HERO_PROTEST := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_016.png" # 抗議顔
const HERO_DISTANT := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_083.png" # 遠い目
const HERO_DUSK := "res://assets/characters/main/satoshi/isekai/satoshi_isekai_038.png"    # 夕暮れ俯く
