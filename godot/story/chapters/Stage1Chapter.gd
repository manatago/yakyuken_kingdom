...
func _build_stage1(b):
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_002.png", {"scale": 0.5, "side": "left", "flip": 1})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_002.png", {"scale": 0.6, "side": "left", "flip": 1})
	hero.band("（...あかん、思い出したらニヤけてまう。俺、やっぱりあっちの世界の単位より、こっちの世界の「徳」の方が向いてるのかも。）")

	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_003.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_003.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_004.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_004.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_005.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_005.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_006.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_006.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_010.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [ -50, 0]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_010.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [ -50, 0]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_008.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_008.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_009.png", {"scale": 0.75, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_009.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_011.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_011.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("え？ なんで？")

	pisuke.band("この世界で精霊を連れてる人間ってのは、\n「契約者」か「呪われた者」のどっちかだ。\nどちらにしても厄介事に巻き込まれる。")

	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_012.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_012.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_013.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_013.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_014.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_014.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_017.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_017.png", {"scale": 0.6, "side": "left", "flip": 0, "position": [0, 70]})
	hero.band("（いや、実際弱いし...。）")
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_018.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_018.png", {"scale": 0.6, "side": "left", "flip": 0, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_019.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_019.png", {"scale": 0.6, "side": "left", "flip": 0, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_020.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_020.png", {"scale": 0.6, "side": "left", "flip": 0, "position": [0, 70]})
	hero.band("（ピー助このやろう...！ 俺の声で勝手に啖呵切りやがって...！\n周りの目もあるし...もう逃げられない...。）")

	# ピー助（小声でスキャン結果）
	pisuke.band("ゲコッ。こいつのデッキ、スキャンしたぞ。ノーマルカードばっかりだ。\nベイズ・アイを使えば余裕で勝てる。\n...ほら、覚悟を決めろ。", {"side": "left"})

	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_021.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_021.png", {"scale": 0.6, "side": "left", "flip": 0, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_022.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_022.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_023.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_023.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_024.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_024.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_027.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_027.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_025.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_025.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("（...いや、待てよ。）")
	hero.band("（ベイズ・アイ...水晶には反応したけど、受付嬢には見えてなかった。\nこのスキル、俺にしか見えないのか。）")
	hero.band("（人にドン引きされるのは辛いけど...\n誰にも見えないスキルで確率を操れるってことは...\nこれ、めちゃくちゃ有利じゃないか？）")

	# (旧スケール) hero.set_portrait("res://assets/characters/stage1/char01_st1_026.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/stage1/char01_st1_026.png", {"scale": 0.6, "side": "left", "flip": 1, "position": [0, 70]})
