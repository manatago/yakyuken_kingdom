...
func _build_stage1(b):
	...
	hero.appear({
		...
		"appear_duration": 0.8,
		"appear_distance": 200,
		"portrait": "res://assets/characters/main/satoshi/isekai/satoshi_isekai_048.png",
		"portrait_scale": 0.5,
		"flip": 0,
	})
	hero.band("（マチルダさん...。あの「じゃんけん」に負けて服を脱ぐときの、屈辱と興奮が入り混じった顔。）")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_060.png", {"scale": 0.5, "side": "left", "flip": 0})
	hero.band("（...あかん、思い出したらニヤけてまう。俺、やっぱりあっちの世界の単位より、こっちの世界の「徳」の方が向いてるのかも。）")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_067.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	pisuke.appear({
		...
		"appear_duration": 0.6,
		"appear_distance": 300,
		"portrait": "res://assets/characters/main/pisuke/default/pisuke_default_001.png",
		"portrait_scale": 0.2,
        "position": [0, -600],
	})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_051.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.band("うわっ！？ なんだ、この鳥。...喋った！？")

	pisuke.set_portrait("res://assets/characters/main/pisuke/default/pisuke_default_001.png", {"scale": 0.2, "side": "right", "flip": 1, "position": [-200, -500]})
	pisuke.band("鳥と一緒にすんな。俺様は「ピー助」。お前をガイドするために遣わされた「聖霊（精霊）」様だ。\nお前、サトシだろ？ 異界から迷い込んだ「脳に隙間のある男」。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_061.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_075.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_064.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [ -50, 0]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_056.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	pisuke.set_portrait("res://assets/characters/main/pisuke/default/pisuke_default_005.png", {"scale": 0.2, "side": "right", "flip": 1, "position": [0, -200]})
	pisuke.band("俺様を誰だと思ってる。読み取りどころか、書き換えだって...おっと、これ以上は秘密だ。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_076.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_065.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_063.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("え？ なんで？")

	pisuke.band("この世界で精霊を連れてる人間ってのは、\n「契約者」か「呪われた者」のどっちかだ。\nどちらにしても厄介事に巻き込まれる。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_073.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_057.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_062.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.appear({
		...
		"appear_duration": 0.8,
		"appear_distance": 200,
		"portrait": "res://assets/characters/main/satoshi/isekai/satoshi_isekai_033.png",
		"portrait_scale": 0.5,
		"flip": 0,
	})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_099.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.band("（いや、実際弱いし...。）")
	...
	adventurer_a.appear({
		...
		"appear_duration": 0.6,
		"appear_distance": 200,
		"portrait": "res://assets/characters/mob/adventurer_a/clothed/adventurer_a_clothed_001.png",
		"portrait_scale": 0.6,
		"flip": 0,
	})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_113.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.band("（変態顔...！？ そんなにニヤけてたか俺...。\nいや確かにマチルダさんのこと思い出してたけど...くそ、地味に傷つく...。）")

	adventurer_a.band("ここは冒険者ギルドだ。新入りは「通過儀礼」を受けてもらうぜ。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_095.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_112.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.band("え、いや、あの...急いでるので...。")

	# ピー助がサトシの声色を真似て挑発
	hero.band("はぁ！？ 通過儀礼だぁ？ そんなもん、こっちから望むところだ！\nてめえみたいな三下のカードを全部剥いで、\nギルドの入り口に「敗北者の記念碑」として飾ってやるよ！")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_105.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_107.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	hero.band("（ピー助このやろう...！ 俺の声で勝手に啖呵切りやがって...！\n周りの目もあるし...もう逃げられない...。）")

	# ピー助（小声でスキャン結果）
	pisuke.band("ゲコッ。こいつのデッキ、スキャンしたぞ。ノーマルカードばっかりだ。\nベイズ・アイを使えば余裕で勝てる。\n...ほら、覚悟を決めろ。", {"side": "left"})

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_039.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_127.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_119.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_115.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_117.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_122.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_121.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("あ、ありがとうございます...。")
	hero.band("（...カウンター置きだった。完全に変態だと思われてる。）")
	pisuke.band("自業自得だな。まあ登録できたんだし、第一歩だ。", {"side": "left"})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_125.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_043.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("（...いや、待てよ。）")
	hero.band("（ベイズ・アイ...水晶には反応したけど、受付嬢には見えてなかった。\nこのスキル、俺にしか見えないのか。）")
	hero.band("（人にドン引きされるのは辛いけど...\n誰にも見えないスキルで確率を操れるってことは...\nこれ、めちゃくちゃ有利じゃないか？）")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_129.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
