...
func _build_subevent2_pre1(b):
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_011.png", {"scale": 0.60, "side": "left", "flip": 1, "position": [-90, 200]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_047.png", {"scale": 0.60, "side": "left", "flip": 1, "position": [-80, 200]})
	hero.band("（詰んだ...！）")
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_042.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [0, 0]})
	hero.band("一旦？ 条件？")
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_064.png", {"scale": 0.60, "side": "left", "flip": 1, "position": [-90, 200]})
	...
	b.background("res://assets/backgrounds/subevent2/bg01_church_exterior.png", 0.5)
	b.show_band()
	...
	b.background("res://assets/backgrounds/subevent2/bg02_church_interior.png", 0.5)
	b.show_band()
	...
	sister_a.appear({
		...
		"appear_duration": 0.6,
		"appear_distance": 200,
		"portrait": "res://assets/characters/mob/sister_a/clothed/sister_a_clothed_001.png",
		"portrait_scale": 0.5,
		"flip": 0,
		"position": [0, 60],
	})
	...
	sister_a.set_portrait("res://assets/characters/mob/sister_a/clothed/sister_a_clothed_001.png", {"scale": 0.5, "side": "right", "flip": 0, "position": [0, 60]})
	...
	b.background("res://assets/backgrounds/subevent2/bg03_church_backyard.png", 0.5)
	b.show_band()
...
func _build_subevent2_pre2(b):
	...
	b.background("res://assets/backgrounds/subevent2/bg04_church_corridor.png", 0.5)
	b.show_band()
	...
	b.background("res://assets/backgrounds/subevent2/bg05_church_peep_room.png", 0.5)
	b.show_band()
...
func _build_subevent2_post(b):
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_033.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [0, 0]})
...
func _build_subevent2_battle_lose(b):
	...
	b.background("res://assets/backgrounds/subevent2/bg06_church_dungeon.png", 0.5)
	b.show_band()
