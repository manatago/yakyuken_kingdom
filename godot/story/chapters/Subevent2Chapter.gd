...
func _build_subevent2_pre1(b):
	...
	hero.appear({
		...
		"appear_duration": 0.8,
		"appear_distance": 200,
		"portrait": "res://assets/characters/main/satoshi/isekai/satoshi_isekai_005.png",
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_074.png", {"scale": 0.67, "side": "left", "flip": 0, "position": [-40, 340]})
	...
	receptionist.set_portrait(RECEP_STERN, {"scale": 0.45, "side": "right", "flip": 0, "position": [0, 0]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_047.png", {"scale": 0.67, "side": "left", "flip": 1, "position": [-80, 350]})
	hero.band("（詰んだ...！）")
	...
	receptionist.set_portrait(RECEP_SMILE, {"scale": 0.45, "side": "right", "flip": 0, "position": [0, 0]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_042.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("一旦？ 条件？")

	receptionist.band("この件、サトシ様に調査していただきます。\n...正式な依頼ではなく、非公式で。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_024.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_064.png", {"scale": 0.64, "side": "left", "flip": 1, "position": [-90, 290]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_028.png", {"scale": 0.67, "side": "left", "flip": 0, "position": [-40, 340]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_013.png", {"scale": 0.5, "side": "left", "flip": 1, "position": [0, 70]})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_093.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
...
func _build_subevent2_pre2(b):
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_006.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_027.png", {"scale": 0.67, "side": "left", "flip": 1, "position": [-90, 350]})
	...
	sister_head.set_portrait(SISTER_HEAD_SAD, {"scale": 0.54, "side": "right", "flip": 0, "position": [20, 140]})
	...
	guard.set_portrait(GUARD_ANGRY, {"scale": 0.40, "side": "right", "flip": 0, "position": [0, 0]})
	...
	guard.appear({
		"side": "right", "appear_effect": "fade", "appear_duration": 0.3,
		"portrait": GUARD_TIRED, "portrait_scale": 0.40, "flip": 0, "position": [0, 0],
	})
	guard.band("...はぁ。三度目の現行犯、か。ほら、来い。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_039.png", {"scale": 0.67, "side": "left", "flip": 1, "position": [-110, 345]})
	...
	guard.appear({
		"side": "right", "appear_effect": "fade", "appear_duration": 0.3,
		"portrait": GUARD_TIRED, "portrait_scale": 0.40, "flip": 0, "position": [0, 62],
	})
...
func _build_subevent2_post(b):
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_051.png", {"scale": 0.71, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_033.png", {"scale": 0.5, "side": "left", "flip": 1, "position": [0, 70]})
