...
func _build_subevent1_pre(b):
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_001.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 69]})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_001.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 69]})
	hero.band("いや待て。「パンツ専門盗賊団」って何だよ。\n...金品じゃなくてパンツだけ盗むのか？")

	pisuke.band("この世界じゃ下着にも魔力が宿るんだよ。\n特に美女の下着は闘市場で高値がつく。\n...まあ、それ以外の動機もあるんだろうがな。", {"side": "left"})

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_001.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 74]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_001.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 74]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_001.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 64]})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_001.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 64]})
	hero.band("は、はい。")
