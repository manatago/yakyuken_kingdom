...
func _build_subevent1_pre(b):
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_017.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 69]})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_017.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 69]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_013.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_014.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 65]})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_014.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 65]})
	hero.band("はい。...たぶん。")
	# ピー助がサトシの声色で叫ぶ
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_015.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 64]})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_015.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 64]})
	hero.band("は、はい。")
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_012.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_016.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
