...
func _build_subevent1_pre(b):
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_017.png", {"scale": 0.50, "side": "left", "flip": 0, "position": [0, 0]})
	hero.band("いや待て。「パンツ専門盗賊団」って何だよ。\n...金品じゃなくてパンツだけ盗むのか？")

	pisuke.band("この世界じゃ下着にも魔力が宿るんだよ。\n特に美女の下着は闘市場で高値がつく。\n...まあ、それ以外の動機もあるんだろうがな。", {"side": "left"})

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_005.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_007.png", {"scale": 0.74, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_013.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [0, 0]})
	hero.band("男のパンツも...？")
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_005.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_014.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [0, 0]})
	hero.band("はい。...たぶん。")
	# ピー助がサトシの声色で叫ぶ
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_015.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [0, 0]})
	hero.band("は、はい。")
...
func _build_subevent1_hideout(b):
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_012.png", {"scale": 0.50, "side": "left", "flip": 0, "position": [0, 0]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_026.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [0, 0]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_016.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [-20, 10]})
	...
	# ガルド敗北
	gald.set_portrait("res://assets/characters/mob/gald/clothed/gald_clothed_003.png", {"scale": 0.40, "side": "right", "flip": 0, "position": [0, 0]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_026.png", {"scale": 0.50, "side": "left", "flip": 0, "position": [0, 0]})
	hero.band("...うわ。壁にパンツが飾ってある。しかも額縁入り。\n...美術館かよ。")

	pisuke.band("「パンツ・ギャラリー」だな...。\n作品名のプレートまで付いてやがる。\n「朝露に濡れたシルク」「黄昏のレース」...。", {"side": "left", "scale": 0.65, "position": [-45, 360], })

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_082.png", {"scale": 0.53, "side": "left", "flip": 0, "position": [0, 70]})
	...
	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_002.png", {"scale": 0.49, "side": "right", "flip": 0, "position": [0, 60]})
	belka.band_retry(
		"encounter_belka_seen",
		"ジンもマルコもガルドもやられたって？\n...ひとりで？ マジで？\n...あんた、ギルドの冒険者？\nなんか頼りなさそうだけど...。",
		"まあ、ボクのコレクションが増えるなら、\nそれはそれで歓迎だけどね。\n...今度こそ、丁寧に剥いでやるよ。"
	...
	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_003.png", {"scale": 0.49, "side": "right", "flip": 0, "position": [0, 60]})
	belka.band("...ふーん。ボクのギャラリー、じっくり見てたろ。\nさっき聞こえたぜ。「保存状態がプロの仕事」だって？")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_010.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("それは俺じゃなくて...！", {"scale": 0.43, "position": [0, 61]})

	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_005.png", {"scale": 0.43, "side": "right", "flip": 0, "position": [0, -22]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_047.png", {"scale": 0.63, "side": "left", "flip": 1, "position": [-70, 270]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_012.png", {"scale": 0.50, "side": "left", "flip": 1, "position": [0, 0]})
	...
	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_001.png", {"scale": 0.49, "side": "right", "flip": 0, "position": [0, 62]})
	...
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_006.png", {"scale": 0.53, "side": "left", "flip": 1, "position": [0, 70]})
	...
	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_013.png", {"scale": 0.49, "side": "right", "flip": 0, "position": [0, 62]})
...
func _build_subevent1_post(b):
	...
	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_009.png", {"scale": 0.58, "side": "right", "flip": 0, "position": [0, 250]})
	...
	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_010.png", {"scale": 0.58, "side": "right", "flip": 0, "position": [0, 250]})
	belka.band("...ふーん。あんた、何者だよ。\nまるで、確率が見えてるみたいだった。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_055.png", {"scale": 0.74, "side": "left", "flip": 1, "position": [0, 70]})
	hero.band("いや、まあ、ちょっとした数学の応用です。")

	belka.set_portrait("res://assets/characters/main/belka/clothed/belka_clothed_011.png", {"scale": 0.58, "side": "right", "flip": 0, "position": [0, 250]})
	belka.band("約束は守るよ。シルキーファングは今日で解散だ。\n盗品も返す。...騎士団、呼べばいいよ。")

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_051.png", {"scale": 0.74, "side": "left", "flip": 1, "position": [0, 70]})
	...
	belka.appear({
		...
		"portrait_scale": 0.58, "flip": 0, "position": [0, 250],
	})
	...
	# (旧スケール) hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_001.png", {"scale": 0.43, "side": "left", "flip": 0, "position": [0, 61]})
	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_020.png", {"scale": 0.70, "side": "left", "flip": 1, "position": [-90, 400]})
	hero.band("（パンツ盗賊団を壊滅させた英雄のはずなのに...\nなんであの番兵がまた来るんだ...運が悪すぎる...。）")

	pisuke.band("ゲコッ。まあ、金は稼げたな。次の仕事を探すぞ。", {"side": "left"})

	hero.set_portrait("res://assets/characters/main/satoshi/isekai/satoshi_isekai_053.png", {"scale": 0.81, "side": "left", "flip": 1, "position": [-20, 140]})
